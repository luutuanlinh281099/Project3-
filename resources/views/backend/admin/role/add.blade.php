...
<div class="content-wrapper">
    @include('backend.partials.content-header', ['name' => 'Vai trò', 'key' => 'Thêm mới'])
    <div class="content">
                        ...
                        <div class="row">
                            ...
                            <div class="card border-primary mb-3 col-md-12">
                                <div class="card-header">
                                    <label class="form-check-label" for="materialChecked2">>
                                        <input type="checkbox" name="permission_id[]" value="{{ $permissionsParentItem->id }}" class="checkbox_wrapper">
                                    </label>
